...
import BoldIntegrationScenario1Spec from "./BoldIntegrationScenario1Spec";
...
const routes = [
    ...
    <Route key="boldIntegrationScenario1Spec" path="/bold-integration-scenario1-spec" element={<BoldIntegrationScenario1Spec />} />,
